...
import static org.devit.bookstore.orders.testdata.TestDataFactory.*;
...
class OrderControllerUnitTests {
    ...
    @BeforeEach
    void setUp() {
        when(securityService.getLoginUserName()).thenReturn("siva");
    }

    @ParameterizedTest(name = "[{index}]-{0}")
    @MethodSource("createOrderRequestProvider")
    void shouldReturnBadRequestWhenOrderPayloadIsInvalid(CreateOrderRequest request) throws Exception {
        when(orderService.createOrder(eq("siva"), any(CreateOrderRequest.class)))
                .thenReturn(null);
